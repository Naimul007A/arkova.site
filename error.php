...
<head>
    ...
    <title>Maintenance | <?php echo $domain ?></title>
    <meta property="og:title" content="Maintenance | <?php echo $domain ?>">
...
<body>
    <article>
        ...
        <div>
            <p>Apologies for any inconvenience caused. We are currently undergoing maintenance. If you wish, you can
                stay informed about the progress by following us on <a href="https://facbook.com">Facbook</a>. Rest
                assured, we will be up and running again soon!</p>
        </div>
    </article>
</body>
